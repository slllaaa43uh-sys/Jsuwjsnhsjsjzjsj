  ...
  const handlePostSubmit = async (postPayload: any) => {
    if (postPayload.isShort && postPayload.rawVideoFile) {
        ...
        const performBackgroundShortUpload = async () => {
             try {
                ...
                // or if only 1 file and it's not explicitly an image
                ...
                const finalPayload = {
                    ...
                    rawVideoFile: undefined, rawCoverFile: undefined, tempVideoUrl: undefined
                };
    ...
    const performBackgroundUpload = async () => {
      try {
        ...
        if (finalPayload.rawMedia?.length > 0) {
            const uploaded = await uploadFiles(finalPayload.rawMedia);
